...
import { FooterTypes, HeaderTypes } from '../types/general';
import { getAddress } from '@/utils/custom';
import i18n from '../locales/i18n';
import parse from 'html-react-parser';

const Footer = ({ footer, header }: { footer: FooterTypes | null, header: HeaderTypes | null }) => {
  if (!footer) return
  return (
    <footer>
        ...
        <div className="lc-footer-container">
          ...
          <div className="lc-footer-group text-md-center">
            ...
            <div className="lc-footer-info" data-aos="fade-up">
              {parse(footer.company_description)}
            </div>
            ...
            <div className="lc-footer-location" data-aos="fade-up">
              ...
              <div className="es-location-text">
                {parse(getAddress(footer, i18n.language))}
              </div>
            </div>
          </div>
          ...
          <div className="lc-footer-container">
            ...
            <div className="lc-footer-group">
              <div className="lc-socials">
                {header?.instagram_link && <Link className="lc-social-ic" href={header.instagram_link} target="_blank">
                  <Image src={require("../assets/img/ic_instagram_black.svg")} alt="instagram" />
                </Link>}
                {header?.facebook_link && <Link className="lc-social-ic" href={header.facebook_link} target="_blank">
                  <Image src={require("../assets/img/ic_facebook_bl.svg")} alt="facebook" />
                </Link>}
                {header?.telegram_link && <Link className="lc-social-ic" href={header.telegram_link} target="_blank">
